...
def main():
  if len(sys.argv) < 3:
        print("Uso: python receive.py <interface conectada com switchCore> <nome do arquivo>(ex:e2-eth1 E2, sendo E2 nome de arquivo de log que vao ser armazenados os dados)")
        sys.exit(1)
  iface = sys.argv[1]
